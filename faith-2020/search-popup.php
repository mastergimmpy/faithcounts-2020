...
?>
<main>
  <div class="container thirteenseventyfive" id="searchWrapper">
    ...
    <div class="filter-wrapper has-selection">
    <?php 
      ...
      $total_count = $count_videos + $count_articles + $count_sharables + $count_downloads + $count_podcasts;
      ?>
      ...
      <div id="filters-btn" class="single-filter<?php if ($search_filter=='') {
        ...
        <div class="filter-count"><?php echo count($all_posts); ?></div>
      </div>
      <div id="video-btn" class="single-filter<?php if ($search_filter=='videos') {
        ...
        <div class="filter-count" id="video-filter-count" data-videosearchcount="<?php echo $count_videos; ?>"><?php echo $count_videos; ?></div>
      </div>
      <div id="article-btn" class="single-filter<?php if ($search_filter=='post') {
        ...
        <div class="filter-count" id="article-filter-count" data-articlesearchcount="<?php echo $count_articles; ?>"><?php echo $count_articles; ?></div>
      </div>
      <div id="sharable-btn" class="single-filter<?php if ($search_filter=='sharables') {
        ...
        <div class="filter-count" id="sharable-filter-count" data-sharablessearchcount="<?php echo $count_sharables; ?>"><?php echo $count_sharables; ?></div>
      </div>
      <div id="podcast-btn" class="single-filter<?php if ($search_filter=='podcasts') {
        ...
        <div class="filter-count" id="podcast-filter-count" data-podcastsearchcount="<?php echo $count_podcasts; ?>"><?php echo $count_podcasts; ?></div>
      </div>
      <div id="download-btn" class="single-filter<?php if ($search_filter=='downloads') {
        ...
        <div class="filter-count" id="download-filter-count" data-downloadssearchcount="<?php echo $count_downloads; ?>"><?php echo $count_downloads; ?></div>
      </div>
    </div>
